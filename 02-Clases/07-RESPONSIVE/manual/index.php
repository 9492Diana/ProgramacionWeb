...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <section class="importante">
            <?php
                ...
                while ( $row = mysql_fetch_array($resultado) ) {
                    ...
                    echo "</a></p><br />";
                    echo "<img class='imgPost' src='img/".$row["urlImagen"]."' />";
                    echo "<p class='txtPost'>".$row["texto"]."</p>";
                    echo "<span class='icon-star favs";
                    if($row["fav"]==1) { echo " favorita"; }
                    echo "' ></span>";
        ...
        <aside class="noImportante">
            <h3>No soy importante</h3>
        </aside>
